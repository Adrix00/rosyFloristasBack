...
/** Closes an inventory alert as acknowledged, no action needed (inventory.md, section 3.8: "Descartar"). */
public interface DismissInventoryAlertUseCase {
   ...
   */
  InventoryAlertDto execute(DismissInventoryAlertCommand command);
}
