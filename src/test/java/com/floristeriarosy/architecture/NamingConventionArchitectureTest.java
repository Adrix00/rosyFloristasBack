 ...
 *
 * <p>Estas reglas garantizan que todos los desarrolladores utilicen la misma convención de nombres
 * independientemente del módulo que implementen.
 *
 * <p>Gracias a ello todos los módulos (Category, Product, Order, Customer...) tendrán exactamente
 * la misma estructura.
 */
@AnalyzeClasses(
...
class NamingConventionArchitectureTest {
  ...
  @ArchTest
  static final ArchRule requests_should_have_request_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule responses_should_have_response_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule commands_should_have_command_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule queries_should_have_query_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule use_cases_should_have_use_case_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule output_ports_should_have_port_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule adapters_should_have_adapter_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule jpa_repositories_should_have_jpa_repository_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule jdbc_repositories_should_have_jdbc_repository_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule persistence_mappers_should_have_mapper_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule web_mappers_should_have_mapper_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule row_mappers_should_have_row_mapper_suffix =
      classes()
          .that()
  ...
  @ArchTest
  static final ArchRule projections_should_have_projection_suffix =
      classes()
          .that()
