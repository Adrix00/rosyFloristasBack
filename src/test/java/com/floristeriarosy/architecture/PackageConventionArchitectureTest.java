 ...
 *
 * A diferencia de NamingConventionArchitectureTest, que valida el nombre de las
 * clases, este test valida que cada tipo de clase resida en el paquete que le
 * corresponde.
 *
 * Gracias a ello todos los módulos mantienen exactamente la misma estructura.
 */
...
class PackageConventionArchitectureTest {
    ...
    @ArchTest
    static final ArchRule requests_should_reside_in_request_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule responses_should_reside_in_response_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule commands_should_reside_in_command_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule queries_should_reside_in_query_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule use_cases_should_reside_in_port_in_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule output_ports_should_reside_in_port_out_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule persistence_adapters_should_reside_in_adapter_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule jpa_repositories_should_reside_in_jpa_repository_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule jdbc_repositories_should_reside_in_jdbc_repository_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule persistence_mappers_should_reside_in_persistence_mapper_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule web_mappers_should_reside_in_web_mapper_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule row_mappers_should_reside_in_row_mapper_package = classes()
            .that()
    ...
    @ArchTest
    static final ArchRule projections_should_reside_in_projection_package = classes()
            .that()
